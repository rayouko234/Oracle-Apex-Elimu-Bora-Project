...
@@application/deployment/install/install_projects.sql
@@application/deployment/install/install_files.sql
@@application/deployment/install/install_data_load_spec.sql
@@application/deployment/install/install_demo_load_body.sql
